                ...
                case -95:
                    {
                        ...
                        if (b48 == 0)
                        {
                            ...
                            else
                            {
                                ...
                                if (@char != null)
                                {
                                    Mob mob6 = new Mob(num117, isDisable: false, isDontMove: false, isFire: false, isIce: false, isWind: false, templateId, 1, num118, 0, num118, (short)@char.cx, (short)@char.cy, 4, 0);
                                    mob6.isMobMe = true;
                                    @char.mobMe = mob6;
                                ...
                                else
                                {
                                    ...
                                    if (mob7 == null)
                                    {
                                        mob7 = new Mob(num117, isDisable: false, isDontMove: false, isFire: false, isIce: false, isWind: false, templateId, 1, num118, 0, num118, -100, -100, 4, 0);
                                        mob7.isMobMe = true;
                        ...
                        if (b48 == 3)
                        {
                            ...
                            if (@char != null)
                            {
                                ...
                                if (mob != null)
                                {
                                    ...
                                    {
                                        GameScr.startFlyText("-" +  NinjaUtil.getMoneys(num124), mob.x, mob.y - mob.h, 0, -2, mFont.ORANGE);
                                    }
                                }
                            }
                        }
                        ...
                        if (b48 == 5)
                        {
                            ...
                            {
                                GameScr.startFlyText("-" + NinjaUtil.getMoneys(num126), mob8.x, mob8.y - mob8.h, 0, -2, mFont.ORANGE);
                            }
                        }
                        if (b48 == 6)
                        {
                ...
                case -45:
                    {
                        ...
                        if (b53 == 4)
                        {
                            ...
                            else if (GameScr.findCharInMap(num145) != null)
                            {
                                ...
                                {
                                    case 0:
                                        GameScr.findCharInMap(num145).useChargeSkill(isGround: false);
                                        break;
                                    case 1:
                                        GameScr.findCharInMap(num145).useChargeSkill(isGround: true);
                                        break;
                                }
                ...
                case -67:
                    {
                        ...
                        {
                            array18 = null;
                            SmallImage.imgNew[num174].img = Image.createRGBImage(new int[1], 1, 1, bl: true);
                        }
                ...
                case 56:
                    {
                        ...
                        if (num9 == Char.myCharz().charID)
                        {
                            ...
                            if (Char.myCharz().cTypePk != 4)
                            {
                                ...
                                {
                                    GameScr.startFlyText("-" + NinjaUtil.getMoneys(num16), @char.cx, @char.cy - @char.ch, 0, -3, flag3 ? mFont.FATAL : mFont.RED);
                                }
                            }
                            break;
                        }
                        ...
                        if (@char.cTypePk != 4)
                        {
                            ...
                            {
                                GameScr.startFlyText("-" + NinjaUtil.getMoneys(num18), @char.cx, @char.cy - @char.ch, 0, -3, flag4 ? mFont.FATAL : mFont.ORANGE);
                            }
                        }
                        break;
                    }
                ...
                case -20:
                    {
                        ...
                        for (int num115 = 0; num115 < GameScr.vItemMap.size(); num115++)
                        {
                            ...
                            if (text5.Equals(string.Empty))
                            {
                                if (itemMap2.template.type == 9)
                                {
                                    GameScr.startFlyText(((num >= 0) ? "+" : string.Empty) + NinjaUtil.getMoneys(num), Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch, 0, -2, mFont.YELLOW);
                                    SoundMn.gI().getItem();
                                }
                                else if (itemMap2.template.type == 10)
                                {
                                    GameScr.startFlyText(((num >= 0) ? "+" : string.Empty) + NinjaUtil.getMoneys(num), Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch, 0, -2, mFont.GREEN);
                                    SoundMn.gI().getItem();
                                }
                                else if (itemMap2.template.type == 34)
                                {
                ...
                case -2:
                    {
                        ...
                        GameScr.startFlyText((num197 <= 0) ? (string.Empty + NinjaUtil.getMoneys(num197)) : ("+" + NinjaUtil.getMoneys(num197)), Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch - 10, 0, -2, mFont.YELLOW);
                        break;
                    }
                case 95:
                    {
                        ...
                        Char.myCharz().xuStr = mSystem.numberTostring(Char.myCharz().xu);
                        GameScr.startFlyText((num184 <= 0) ? (string.Empty + NinjaUtil.getMoneys(num184)) : ("+" + num184), Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch - 10, 0, -2, mFont.YELLOW);
                        break;
                    }
                case 96:
                ...
                case -1:
                    {
                        ...
                        GameScr.startFlyText("+" + NinjaUtil.getMoneys(num196), Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch - 10, 0, -2, mFont.YELLOW);
                        break;
                    }
                case -3:
                    {
                        ...
                        {
                            GameScr.startFlyText(((num181 <= 0) ? string.Empty : "+") + NinjaUtil.getMoneys(num181), Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch, 0, -4, mFont.GREEN);
                ...
                case -9:
                    {
                        ...
                        if (mob9 != null)
                        {
                            ...
                            if (flag10)
                            {
                                GameScr.startFlyText("-" + NinjaUtil.getMoneys(num183), mob9.x, mob9.getY() - mob9.getH(), 0, -2, mFont.FATAL);
                            }
                            else if (num183 == 0)
                            {
                                mob9.x = mob9.xFirst;
                            ...
                            {
                                GameScr.startFlyText("-" + NinjaUtil.getMoneys(num183), mob9.x, mob9.getY() - mob9.getH(), 0, -2, mFont.ORANGE);
                            }
                        }
                ...
                case -12:
                    {
                        ...
                        try
                        {
                            ...
                            {
                                GameScr.startFlyText("-" + NinjaUtil.getMoneys(num192), mob9.x, mob9.y - mob9.h, 0, -2, mFont.FATAL);
                            }
                            else
                            {
                                GameScr.startFlyText("-" + NinjaUtil.getMoneys(num192), mob9.x, mob9.y - mob9.h, 0, -2, mFont.ORANGE);
                            }
                ...
                case 5:
                    {
                        ...
                        {
                            GameScr.startFlyText("+" + NinjaUtil.getMoneys((Char.myCharz().cHP - cHP)) + " " + mResources.HP, Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch - 20, 0, -1, mFont.HP);
                            SoundMn.gI().HP_MPup();
                        ...
                        {
                            GameScr.startFlyText("-" + NinjaUtil.getMoneys((cHP - Char.myCharz().cHP)) + " " + mResources.HP, Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch - 20, 0, -1, mFont.HP);
                        }
                        GameScr.gI().dHP = Char.myCharz().cHP;
                        if (GameScr.isPaintInfoMe)
                        {
                ...
                case 6:
                    {
                        ...
                        {
                            GameScr.startFlyText("+" + NinjaUtil.getMoneys((Char.myCharz().cMP - cMP)) + " " + mResources.KI, Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch - 23, 0, -2, mFont.MP);
                            SoundMn.gI().HP_MPup();
                        ...
                        if (Char.myCharz().cMP < cMP)
                        {
                            GameScr.startFlyText("-" + NinjaUtil.getMoneys((cMP - Char.myCharz().cMP)) + " " + mResources.KI, Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch - 23, 0, -2, mFont.MP);
                        }
